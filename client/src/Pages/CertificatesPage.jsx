          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            {certificates.length > 0 && (
              <button
                ...
                className={`flex items-center justify-center gap-2 px-4 py-2 font-medium text-white  bg-primary-800 rounded-lg hover:bg-primary-800 disabled:bg-primary-800 disabled:cursor-not-allowed w-full md:w-auto ${mobileMenuOpen ? 'flex' : 'hidden md:flex'}`}
              >
          ...
          <div className="fixed inset-x-0 bottom-0 p-4 bg-white border-t border-gray-200 shadow-lg md:hidden">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={downloadAllCertificates}
                disabled={isDownloadingAll}
                className="px-4 py-2 text-sm font-medium text-white transition-colors bg-primary-800 rounded-lg hover:bg-primary-600 disabled:bg-primary-400"
              >
