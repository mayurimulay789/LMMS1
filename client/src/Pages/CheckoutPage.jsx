            ...
            <div className="hidden sm:block p-4 sm:p-6 bg-white rounded-lg shadow-sm">
              ...
              <form onSubmit={handlePromoCodeSubmit} className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
                ...
                <button
                  ...
                  className="px-4 sm:px-6 py-2 sm:py-3 text-white transition-colors bg-red-800 rounded-lg hover:bg-red-800 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base whitespace-nowrap"
                >
