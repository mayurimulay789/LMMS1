...
//             className="flex items-center justify-center w-full gap-2 px-4 py-2 text-white transition-colors bg-primary-600 rounded-lg hover:bg-primary-700 md:w-auto"
//           >
...
//               <button
//                 type="submit"
//                 className="flex items-center justify-center w-full gap-2 px-4 py-2 text-white transition-colors bg-primary-600 rounded-lg hover:bg-primary-700 disabled:bg-blue-400 disabled:cursor-not-allowed md:w-auto"
//                 disabled={isUploading}
//               >
